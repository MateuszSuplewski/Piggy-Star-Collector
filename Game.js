...
class Game {
  ...
  startGame() {
    ...
    this.ui.health = 1;
    this.active = true;
    this.controls.cameraBase.getWorldPosition(this.camera.position);
    this.controls.cameraBase.getWorldQuaternion(this.camera.quaternion);
    this.elm.innerHTML = this.CollectedStar;
    this.sfx.play("background_music");
  }

  intersectionWithStars() {
    ...
    if (
      this.stars[0].parent.visible == false &&
      this.stars[1].parent.visible == false &&
      this.stars[2].parent.visible == false &&
      this.stars[3].parent.visible == false &&
      this.stars[4].parent.visible == false &&
      this.stars[5].parent.visible == false &&
      this.stars[6].parent.visible == false &&
      this.stars[7].parent.visible == false &&
      this.stars[8].parent.visible == false &&
      this.stars[9].parent.visible == false
    ) {
      this.active = false;
      this.ui.showWinGame();
  ...
  initPathfinding(navmesh) {
    ...
    if (this.npcHandler.gltf !== undefined) this.npcHandler.initBots();
  }
  ...
  load() {
    ...
    this.npcHandler = new BotSettings(this);
  ...
  render() {
    ...
    if (this.controls !== undefined) this.controls.update(dt);
